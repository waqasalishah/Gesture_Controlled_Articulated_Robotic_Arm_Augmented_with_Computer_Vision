...
Description:    This file compares the face picture from the camera and compares it with
                calculates the distances of key features in a face then compares
                it with the distances from the database to recognise the face 
Inputs:         Database, face picture from camera
Outputs:        Confidance of recognization with name and box around the face
Created on:     Aug 2023
